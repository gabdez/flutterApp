...
class DialogEditJoueur extends StatefulWidget {
  final Joueur joueur;
  DialogEditJoueur({this.joueur});

  @override
  DialogEditJoueurState createState() => DialogEditJoueurState();
}

class DialogEditJoueurState extends State<DialogEditJoueur> {
  ...
  @override
  void initState() {
    nomController.text = widget.joueur.name;
    prenomController.text = widget.joueur.prenom;
    numeroController.text = widget.joueur.numero.toString();
    _selectedPoste = widget.joueur.poste;
    _estTitulaire = widget.joueur.estTitulaire;
  ...
  void editJoueur() {
    widget.joueur.prenom = prenomController.text;
    widget.joueur.name = nomController.text;
    widget.joueur.numero = int.parse(numeroController.text);
    widget.joueur.estTitulaire = _estTitulaire;
    widget.joueur.poste = _selectedPoste;
